...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tcc Bahia" },
      { name: "description", content: "Tcc Bahia — high school capstone (TCC) repository. Students submit, teachers approve, everyone browses." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Tcc Bahia" },
      { property: "og:description", content: "Tcc Bahia — high school capstone (TCC) repository." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Tcc Bahia" },
      { name: "twitter:description", content: "Tcc Bahia — high school capstone (TCC) repository." },
